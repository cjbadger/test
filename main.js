/* << START DEMO JS (from https://stripe.com/docs/payments/card-element?lang=node) */
...
const initializeStripe = (style = defaultStripeConfig) => {
    console.log("Initializing stripe component");
    console.log(style);
...
window.addEventListener("message", (e) => {
    console.log("Message received via postMessage.");
    console.log(e);
    const data = e.data;
